...
for i in selinux.sh firewalld.sh epel.sh pgdg.sh postgresql.sh ambari.sh ambari-server.sh puppet-agent.sh
do
...
for i in selinux.sh firewalld.sh epel.sh ambari.sh ambari-agent.sh puppet-agent.sh
do
